...
public class breadthFirstM
{
	...
	private Queue<point> foodLocations;
	...
	public breadthFirstM(int[][] array,int rowNumber,int colNumber,point currentLocation,Set<point> foodLocations)
	{
		this.array=array;
	...
	public void breadthFirstMAlgorithm()
	{
		...
		point foodLocation = foodLocations.remove();
