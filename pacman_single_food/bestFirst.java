...
public class bestFirst
{
	...
	public int getDirection()
	{
		...
		upCost=getHeuristic(currentLocation.getRow()-1,currentLocation.getCol());
		downCost=getHeuristic(currentLocation.getRow()+1,currentLocation.getCol());
		leftCost=getHeuristic(currentLocation.getRow(),currentLocation.getCol()-1);
		rightCost=getHeuristic(currentLocation.getRow(),currentLocation.getCol()+1);
	...
	{
		return getHeuristicG()+getHeuristicH(row,col);
	}
}